...
public class ExpandableSecondTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final String TAG = ExpandableSecondTextView.class.getSimpleName();
    ...
    public ExpandableSecondTextView(Context context) {
        this(context, null);
    }

    public ExpandableSecondTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ExpandableSecondTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setOrientation(int orientation){
        if(LinearLayout.HORIZONTAL == orientation){
            throw new IllegalArgumentException("ExpandableSecondTextView only supports Vertical Orientation.");
        }
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableSecondTextView);
        mMaxCollapsedLines = typedArray.getInt(R.styleable.ExpandableSecondTextView_maxCollapsedLines, MAX_COLLAPSED_LINES);
        mAnimationDuration = typedArray.getInt(R.styleable.ExpandableSecondTextView_animDuration, DEFAULT_ANIM_DURATION);
        mAnimAlphaStart = typedArray.getFloat(R.styleable.ExpandableSecondTextView_animAlphaStart, DEFAULT_ANIM_ALPHA_START);
        mExpandableTextId = typedArray.getResourceId(R.styleable.ExpandableSecondTextView_expandableTextId, R.id.expandable_text);
        mExpandCollapseToggleId = typedArray.getResourceId(R.styleable.ExpandableSecondTextView_expandCollapseToggleId, R.id.expand_collapse);
        mExpandToggleOnTextClick = typedArray.getBoolean(R.styleable.ExpandableSecondTextView_expandToggleOnTextClick, true);
    ...
    private static ExpandIndicatorController setupExpandToggleController(@NonNull Context context, TypedArray typedArray) {
        final int expandToggleType = typedArray.getInt(R.styleable.ExpandableSecondTextView_expandToggleType, DEFAULT_TOGGLE_TYPE);
        final ExpandIndicatorController expandIndicatorController;
        switch (expandToggleType) {
            case EXPAND_INDICATOR_IMAGE_BUTTON:
                Drawable expandDrawable = typedArray.getDrawable(R.styleable.ExpandableSecondTextView_expandIndicator);
                Drawable collapseDrawable = typedArray.getDrawable(R.styleable.ExpandableSecondTextView_collapseIndicator);
            ...
            case EXPAND_INDICATOR_TEXT_VIEW:
                String expandText = typedArray.getString(R.styleable.ExpandableSecondTextView_expandIndicator);
                String collapseText = typedArray.getString(R.styleable.ExpandableSecondTextView_collapseIndicator);
